...
with col4:
    ...
    st.markdown(f"<h1 style='text-align: center; font-size: 14px;'>Games From week 18 of 2023, the 3rd Most Viewed Week in Regular Season History</h1>", unsafe_allow_html=True)
